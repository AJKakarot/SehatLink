...
export default function Home() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-muted-foreground text-lg md:text-xl max-w-md">
              Connect with doctors, manage visits, and take control of your
              health effortlessly.
            </p>
          ...
          {/* ---------------- Right Side: Animated Stethoscope ---------------- */}
          <div className="relative h-[400px] lg:h-[500px] flex items-center justify-center z-10">
  {/* Pulsing Glow */}
  <motion.div
    animate={{
      scale: [1, 1.2, 1],
      opacity: [0.2, 0.4, 0.2], // lowered
    }}
    transition={{
      repeat: Infinity,
      duration: 2,
    ...
    className="absolute w-[350px] h-[350px] lg:w-[450px] lg:h-[450px] 
               rounded-full bg-gradient-to-r from-emerald-500 via-teal-400 to-sky-500 blur-2xl z-0"
  />
  ...
  >
    <Stethoscope size={260} strokeWidth={2.5} />
  </motion.div>
</div>
        </div>
      </div>
